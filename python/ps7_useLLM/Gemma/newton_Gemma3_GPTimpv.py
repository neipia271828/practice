...
def test_calculate_range():
    ...
    # テストケース
    test_cases = [
        (20, 45, 40.77471967380224),  # 初速度 20 m/s, 発射角度 45度
        (30, 60, 79.36507936507937),  # 初速度 30 m/s, 発射角度 60度
        (10, 30, 8.827433388230813),  # 初速度 10 m/s, 発射角度 30度
        (50, 90, 0.0),                # 初速度 50 m/s, 発射角度 90度
    ]
